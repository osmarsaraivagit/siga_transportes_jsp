...
<%
        ...
        try {
            ...
            if (!cpf.equals(antigo)) {
                rs = st.executeQuery("SELECT * FROM compradores where doc = '" + cpf + "' and corretor = '" + cpfUsuario + "' ");
                while (rs.next()) {
                    rs.getRow();
                    if (rs.getRow() > 0) {
            ...
            if (id.equals("")) {
                ...
                st.executeUpdate("INSERT into compradores (nome, tipo_pessoa, doc, telefone, endereco, corretor) values ('" + nome + "', '" + tipo + "' , '" + cpf + "' , '" + telefone + "', '" + endereco + "', '" + cpfUsuario + "')");
                
            } else {
                
                st.executeUpdate("UPDATE compradores SET nome = '" + nome + "', tipo_pessoa = '" + tipo + "', doc = '" + cpf + "', telefone = '" + telefone + "', endereco = '" + endereco + "' WHERE id = '" + id + "'");
